...
import { EscalationLevel, EscalationDecision } from '@digital-pews/types';

interface EscalationBannerProps {
  decision: EscalationDecision;
}

const levelColors: Record<EscalationLevel, string> = {
  none: '#64748b',
  low: '#3B82F6',
  medium: '#FFD700',
  high: '#FF8C00',
...
const levelTextColors: Record<EscalationLevel, string> = {
  none: '#ffffff',
  low: '#ffffff',
  medium: '#000000',
  high: '#ffffff',
...
const guidanceText: Record<EscalationLevel, string> = {
...
export const EscalationBanner: React.FC<EscalationBannerProps> = ({ decision }) => {
  ...
  return (
    ...
    >
      <h2 style={{ margin: '0 0 0.5rem 0', textTransform: 'uppercase', fontSize: '1.25rem', fontWeight: '800' }}>
