...
async function loadChartScripts() {
  // chart.js is an ES module that imports its config / scorer / age-band
  // dependencies, so we only need to load chart.js itself (as a module).
  await loadScript('/chart.js', { module: true });
}
...
function createStory(patient, observations) {
  return () => {
    ...
    setTimeout(async () => {
      ...
      // No ageBands arg: chart.js uses the AGE_BANDS it imports from config.
      window.NPEWSChart.init(patient, observations);
    }, 0);
    return container;
  };
}
...
const OBSERVATIONS_5_12 = [
  { id: 'obs-n1', timestamp: '2025-01-10T00:00:00', respiratoryRate: 20, respiratoryDistress: 'none', oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 88, bloodPressureSystolic: 98, bloodPressureDiastolic: 62, capillaryRefill: 2, avpu: 'A', temperature: 36.8},
  { id: 'obs-n2', timestamp: '2025-01-10T02:00:00', respiratoryRate: 20, respiratoryDistress: 'none', oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 84, bloodPressureSystolic: 97, bloodPressureDiastolic: 61, capillaryRefill: 2, avpu: 'A', temperature: 36.8},
  { id: 'obs-n3', timestamp: '2025-01-10T04:00:00', respiratoryRate: 20, respiratoryDistress: 'none', oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 85, bloodPressureSystolic: 97, bloodPressureDiastolic: 61, capillaryRefill: 2, avpu: 'A', temperature: 36.8},
  { id: 'obs-n4', timestamp: '2025-01-10T06:00:00', respiratoryRate: 22, respiratoryDistress: 'none', oxygenSaturation: 98, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 90, bloodPressureSystolic: 100, bloodPressureDiastolic: 64, capillaryRefill: 2, avpu: 'A', temperature: 37.0},
  { id: 'obs-1',  timestamp: '2025-01-10T08:00:00', respiratoryRate: 22, respiratoryDistress: 'none', oxygenSaturation: 98, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 95, bloodPressureSystolic: 100, bloodPressureDiastolic: 65, capillaryRefill: 2, avpu: 'A', temperature: 37.1},
  { id: 'obs-2',  timestamp: '2025-01-10T09:00:00', respiratoryRate: 25, respiratoryDistress: 'none', oxygenSaturation: 96, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 105, bloodPressureSystolic: 102, bloodPressureDiastolic: 68, capillaryRefill: 2, avpu: 'A', temperature: 37.8},
  { id: 'obs-3',  timestamp: '2025-01-10T10:00:00', respiratoryRate: 30, respiratoryDistress: 'mild', oxygenSaturation: 94, oxygenDevice: 'NP', oxygenDelivery: { value: 24, unit: '%' }, heartRate: 118, bloodPressureSystolic: null, bloodPressureSystolic_skipReason: 'unable', bloodPressureDiastolic: null, capillaryRefill: 2, avpu: 'A', temperature: 38.2},
  { id: 'obs-4',  timestamp: '2025-01-10T11:00:00', respiratoryRate: 35, respiratoryDistress: 'moderate', oxygenSaturation: 93, oxygenDevice: 'NP', oxygenDelivery: { value: 35, unit: '%' }, heartRate: 128, bloodPressureSystolic: 96, bloodPressureDiastolic: 62, capillaryRefill: 3, avpu: 'A', temperature: 38.6},
  { id: 'obs-5',  timestamp: '2025-01-10T11:30:00', respiratoryRate: 40, respiratoryDistress: 'moderate', oxygenSaturation: 91, oxygenDevice: 'FM', oxygenDelivery: { value: 6, unit: 'L/min' }, heartRate: 138, bloodPressureSystolic: 92, bloodPressureDiastolic: 58, capillaryRefill: 3, avpu: 'A', temperature: 39.0},
  { id: 'obs-6',  timestamp: '2025-01-10T12:00:00', respiratoryRate: 42, respiratoryDistress: 'severe', oxygenSaturation: 89, oxygenDevice: 'HF', oxygenDelivery: { value: 10, unit: 'L/min' }, heartRate: 148, bloodPressureSystolic: 85, bloodPressureDiastolic: 52, capillaryRefill: 4, avpu: 'V', temperature: 39.4},
  { id: 'obs-7',  timestamp: '2025-01-10T12:30:00', respiratoryRate: 38, respiratoryDistress: 'moderate', oxygenSaturation: 92, oxygenDevice: 'HF', oxygenDelivery: { value: 8, unit: 'L/min' }, heartRate: 140, bloodPressureSystolic: 88, bloodPressureDiastolic: 55, capillaryRefill: 3, avpu: 'A', temperature: 38.9},
  { id: 'obs-8',  timestamp: '2025-01-10T14:00:00', respiratoryRate: 32, respiratoryDistress: 'mild', oxygenSaturation: 95, oxygenDevice: 'NP', oxygenDelivery: { value: 4, unit: 'L/min' }, heartRate: 122, bloodPressureSystolic: 97, bloodPressureDiastolic: 61, capillaryRefill: 2, avpu: 'A', temperature: 38.3},
  { id: 'obs-9',  timestamp: '2025-01-10T16:00:00', respiratoryRate: 26, respiratoryDistress: 'none', oxygenSaturation: 97, oxygenDevice: 'NP', oxygenDelivery: { value: 1, unit: 'L/min' }, heartRate: 108, bloodPressureSystolic: 101, bloodPressureDiastolic: 64, capillaryRefill: 2, avpu: 'A', temperature: 37.8},
  { id: 'obs-10', timestamp: '2025-01-10T18:00:00', respiratoryRate: 22, respiratoryDistress: 'none', oxygenSaturation: 98, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 98, bloodPressureSystolic: 103, bloodPressureDiastolic: 66, capillaryRefill: 2, avpu: 'A', temperature: 37.4},
  { id: 'obs-11', timestamp: '2025-01-10T20:00:00', respiratoryRate: 21, respiratoryDistress: 'none', oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 93, bloodPressureSystolic: 101, bloodPressureDiastolic: 64, capillaryRefill: 2, avpu: 'A', temperature: 37.2},
  { id: 'obs-12', timestamp: '2025-01-10T22:00:00', respiratoryRate: 20, respiratoryDistress: 'none', oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null, heartRate: 89, bloodPressureSystolic: 99, bloodPressureDiastolic: 62, capillaryRefill: 2, avpu: 'A', temperature: 37.0},
];
...
const OBSERVATIONS_0_11M = [
  ...
  { id: 'obs-1',  timestamp: '2026-03-18T02:00:00', respiratoryRate: 48, respiratoryDistress: 'moderate', oxygenSaturation: 94, oxygenDevice: 'NP',  oxygenDelivery: { value: 20, unit: '%' }, heartRate: 165, bloodPressureSystolic: 74,   bloodPressureDiastolic: 48, capillaryRefill: 2, avpu: 'V', temperature: 39.2},
  // --- Still postictal, improving ---
  { id: 'obs-2',  timestamp: '2026-03-18T02:30:00', respiratoryRate: 44, respiratoryDistress: 'mild',     oxygenSaturation: 95, oxygenDevice: 'NP',  oxygenDelivery: { value: 20, unit: '%' }, heartRate: 162, bloodPressureSystolic: 72,   bloodPressureDiastolic: 47, capillaryRefill: 2, avpu: 'V', temperature: 39.0},
  // --- Alert, recognises mother ---
  { id: 'obs-3',  timestamp: '2026-03-18T03:00:00', respiratoryRate: 40, respiratoryDistress: 'mild',     oxygenSaturation: 96, oxygenDevice: 'NP',  oxygenDelivery: { value: 20, unit: '%' }, heartRate: 158, bloodPressureSystolic: 74,   bloodPressureDiastolic: 47, capillaryRefill: 2, avpu: 'A', temperature: 39.0},
  // --- 2nd seizure, AVPU=P, SpO2 dips, FM 40% (LINE BREAK: NP% → FM%) ---
  { id: 'obs-4',  timestamp: '2026-03-18T04:00:00', respiratoryRate: 52, respiratoryDistress: 'moderate', oxygenSaturation: 91, oxygenDevice: 'FM',  oxygenDelivery: { value: 40, unit: '%' }, heartRate: 170, bloodPressureSystolic: 70,   bloodPressureDiastolic: 45, capillaryRefill: 3, avpu: 'P', temperature: 39.6},
  // --- Post-ictal, AVPU=V, FM weaned to 24% ---
  { id: 'obs-5',  timestamp: '2026-03-18T04:30:00', respiratoryRate: 46, respiratoryDistress: 'moderate', oxygenSaturation: 93, oxygenDevice: 'FM',  oxygenDelivery: { value: 24, unit: '%' }, heartRate: 168, bloodPressureSystolic: 72,   bloodPressureDiastolic: 46, capillaryRefill: 2, avpu: 'V', temperature: 39.4},
  // --- Alert, stepped down to NP (LINE BREAK: FM% → NP%) ---
  { id: 'obs-6',  timestamp: '2026-03-18T05:00:00', respiratoryRate: 44, respiratoryDistress: 'mild',     oxygenSaturation: 93, oxygenDevice: 'NP',  oxygenDelivery: { value: 20, unit: '%' }, heartRate: 156, bloodPressureSystolic: 74,   bloodPressureDiastolic: 47, capillaryRefill: 2, avpu: 'A', temperature: 38.9},
  // --- Paracetamol working, temp down ---
  { id: 'obs-7',  timestamp: '2026-03-18T06:00:00', respiratoryRate: 42, respiratoryDistress: 'mild',     oxygenSaturation: 95, oxygenDevice: 'NP',  oxygenDelivery: { value: 20, unit: '%' }, heartRate: 150, bloodPressureSystolic: 74,   bloodPressureDiastolic: 47, capillaryRefill: 2, avpu: 'A', temperature: 38.7},
  // --- Temp 38.4°C, NP 15%, less distressed ---
  { id: 'obs-8',  timestamp: '2026-03-18T07:00:00', respiratoryRate: 40, respiratoryDistress: 'mild',     oxygenSaturation: 96, oxygenDevice: 'NP',  oxygenDelivery: { value: 15, unit: '%' }, heartRate: 148, bloodPressureSystolic: 76,   bloodPressureDiastolic: 49, capillaryRefill: 2, avpu: 'A', temperature: 38.4},
  // --- Off O2 (air), temp 38.2°C, accepting feeds ---
  { id: 'obs-9',  timestamp: '2026-03-18T08:00:00', respiratoryRate: 38, respiratoryDistress: 'none',     oxygenSaturation: 97, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 142, bloodPressureSystolic: 76,   bloodPressureDiastolic: 49, capillaryRefill: 2, avpu: 'A', temperature: 38.2},
  // --- Ibuprofen given, temp 37.9°C, normal ---
  { id: 'obs-10', timestamp: '2026-03-18T09:00:00', respiratoryRate: 36, respiratoryDistress: 'none',     oxygenSaturation: 98, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 138, bloodPressureSystolic: 76,   bloodPressureDiastolic: 49, capillaryRefill: 2, avpu: 'A', temperature: 37.9},
  // --- Fully settled, sleeping ---
  { id: 'obs-11', timestamp: '2026-03-18T10:00:00', respiratoryRate: 34, respiratoryDistress: 'none',     oxygenSaturation: 98, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 130, bloodPressureSystolic: 78,   bloodPressureDiastolic: 50, capillaryRefill: 2, avpu: 'A', temperature: 37.6},
  // --- EEG done, BP skipped (procedure) ---
  { id: 'obs-12', timestamp: '2026-03-18T11:00:00', respiratoryRate: 34, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 128, bloodPressureSystolic: null, bloodPressureSystolic_skipReason: 'procedure', bloodPressureDiastolic: null, capillaryRefill: 2, avpu: 'A', temperature: 37.4},
  // --- Stable, discharge planning ---
  { id: 'obs-13', timestamp: '2026-03-18T12:00:00', respiratoryRate: 32, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 126, bloodPressureSystolic: 78,   bloodPressureDiastolic: 50, capillaryRefill: 2, avpu: 'A', temperature: 37.3},
  { id: 'obs-14', timestamp: '2026-03-18T14:00:00', respiratoryRate: 32, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 124, bloodPressureSystolic: 78,   bloodPressureDiastolic: 50, capillaryRefill: 2, avpu: 'A', temperature: 37.2},
  { id: 'obs-15', timestamp: '2026-03-18T16:00:00', respiratoryRate: 30, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 120, bloodPressureSystolic: 78,   bloodPressureDiastolic: 50, capillaryRefill: 2, avpu: 'A', temperature: 37.1},
  { id: 'obs-16', timestamp: '2026-03-18T18:00:00', respiratoryRate: 30, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 118, bloodPressureSystolic: 76,   bloodPressureDiastolic: 49, capillaryRefill: 2, avpu: 'A', temperature: 37.0},
  { id: 'obs-17', timestamp: '2026-03-18T20:00:00', respiratoryRate: 30, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 118, bloodPressureSystolic: 76,   bloodPressureDiastolic: 49, capillaryRefill: 2, avpu: 'A', temperature: 37.0},
  { id: 'obs-18', timestamp: '2026-03-18T22:00:00', respiratoryRate: 30, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 116, bloodPressureSystolic: 76,   bloodPressureDiastolic: 48, capillaryRefill: 2, avpu: 'A', temperature: 36.9},
  { id: 'obs-19', timestamp: '2026-03-19T00:00:00', respiratoryRate: 30, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 114, bloodPressureSystolic: 76,   bloodPressureDiastolic: 48, capillaryRefill: 2, avpu: 'A', temperature: 36.9},
  // --- 24-hour mark, stable, discharge in the morning ---
  { id: 'obs-20', timestamp: '2026-03-19T02:00:00', respiratoryRate: 30, respiratoryDistress: 'none',     oxygenSaturation: 99, oxygenDevice: 'air', oxygenDelivery: null,                     heartRate: 112, bloodPressureSystolic: 76,   bloodPressureDiastolic: 48, capillaryRefill: 2, avpu: 'A', temperature: 36.8},
];
...
// ---------------------------------------------------------------------------
// Birthday crossing: a child charted across an age-band boundary.
// Sam Rivera turns 5 at midnight (2025-01-11T00:00) part-way through a 24-hour
// admission. The chart must JOIN the 1-4y and 5-12y charts seamlessly: one
// continuous trend line on a unified y-scale, with the coloured scoring-band
// backgrounds switching at the birthday and a dashed divider marking the seam.
// Vitals are held roughly constant so the moving band thresholds (and the
// resulting PEWS change) are the visible effect of crossing the boundary.
// ---------------------------------------------------------------------------
...
// Window 2025-01-10T12:00 .. 2025-01-11T12:00 straddles the 5th birthday at
// 2025-01-11T00:00. HR ~95 and RR ~24 stay constant across the boundary so the
// score shift is driven purely by the age band changing.
const OBSERVATIONS_BIRTHDAY_CROSSING = [
  // --- Still 4 years old (1-4y band) ---
  ...
  // --- Turns 5 at midnight: now in the 5-12y band ---
...
export const BirthdayCrossing_1_4_to_5_12 = {
  name: 'Birthday Crossing (turns 5 mid-admission)',
  render: createStory(PATIENT_BIRTHDAY_CROSSING, OBSERVATIONS_BIRTHDAY_CROSSING),
};
