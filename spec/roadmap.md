...
- [ ] **R54 - Approve the chart UI design baseline.** Review R47-R51, R56-R57, and the complete chart against the authoritative NHS references with the clinical reviewers, resolve remaining visual feedback, record who approved the result and when, and declare the UI sufficiently stable for deterministic screenshot baselines. This is a design gate, not a claim that browser regression evidence already exists.
